# [@nordcom/nordstar-select](https://nordcominc.github.io/nordstar/docs/components/select/?utm_source=nordstar&utm_campaign=oss)
...
```sh
npm install @nordcom/nordstar-select
```
