# [@nordcom/nordstar-accordion](https://nordcominc.github.io/nordstar/docs/components/accordion/?utm_source=nordstar&utm_campaign=oss)
...
```sh
npm install @nordcom/nordstar-accordion
```
