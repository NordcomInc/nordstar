...
- [#1229](https://github.com/NordcomInc/nordstar/pull/1229) [`1cf8980`](https://github.com/NordcomInc/nordstar/commit/1cf8980477df2635d39ea6fe63d3a4133bcffdaa) Thanks [@filiphsps](https://github.com/filiphsps)! - Add `<Switch/>`, a boolean toggle built on `@radix-ui/react-switch` with `sm` and
  `md` sizes and a `NordstarColor` checked state. It is keyboard operable,
  form-associated via `name`/`value`, and supports both controlled and uncontrolled
  use. Re-fitted to the Nordstar token contract.
