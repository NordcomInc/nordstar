# [@nordcom/nordstar-switch](https://nordcominc.github.io/nordstar/docs/components/switch/?utm_source=nordstar&utm_campaign=oss)
...
```sh
npm install @nordcom/nordstar-switch
```
